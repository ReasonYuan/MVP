//
//  ChoseRecordViewController.swift
//  DoctorPlus_ios
//
...
class ChoseRecordViewController: BaseViewController,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,ComFqHalcyonLogic2GetRecordListLogic_GetRecordListCallBack,ComFqHalcyonLogic2SurveyRecordLogic_SurveyRecordCallBack{
    ...
    func getRecordList(){
        ...
        logic.getRecordListWithInt(patient!.getMedicalId())
    }
...
//                 cell.imgBg.image = UIImage(named: "record_no_unrec.png")
    ...
    @IBAction func visualize(sender: AnyObject) {
        ...
        let controller:DataVisualizationViewController! = DataVisualizationViewController()
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar) {
        ...
        var controller:SVisualizeRecordViewController! = SVisualizeRecordViewController()
    ...
    override func getXibName() -> String {
        return "ChoseRecordViewController"
    }
