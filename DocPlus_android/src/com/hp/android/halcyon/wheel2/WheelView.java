...
package com.hp.android.halcyon.wheel2;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF, 0x88FFFFFF, 0x66FFFFFF };
	...
	private void drawShadows(Canvas canvas) {
		...
		topShadow.setBounds(0, 0, getWidth(), getHeight() / 2 - getItemHeight() / 2);
		topShadow.draw(canvas);
		//int he = getHeight() / 2;
		//int hegith = getHeight() / 2 + getHeight() / visibleItems;
		bottomShadow.setBounds(0, getHeight() / 2 + getItemHeight() / 2, getWidth(), getHeight());
	...
	public static interface OnClickCenterListener {
		public void OnClickCenter(WheelView view);
	}

	public void setOnClickCenterListener(OnClickCenterListener l) {
		mCenterListener = l;
	}

	private OnClickCenterListener mCenterListener;
	private boolean mTouchCenter = false;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			rect.set(0, center - offset, getWidth(), center + offset);
		...
		case MotionEvent.ACTION_UP:
			rect.set(0, center - offset, getWidth(), center + offset);
			if (mTouchCenter && mCenterListener != null && rect.contains((int) event.getX(), (int) event.getY())) {
				mCenterListener.OnClickCenter(this);
			}
			mTouchCenter = false;
			if (!isScrollingPerformed) {
