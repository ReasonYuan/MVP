...
public class ChoseRecordActivity extends BaseActivity{
	...
	public void init() {
		...
		data = (VisualData) ChoseRecordActivity.this.getIntent().getSerializableExtra("extra");
	...
	private void initListener() {
		mVisLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				if(selectedRecords.size() == 0){
					UITools.showToast("请选择病历");
					return;
				}
				Intent intent = new Intent(ChoseRecordActivity.this, DataVisualizationActivity.class);
		...
		mSearchPatient.setSearchListener(new SearchListener() {
			...
			public void searchCallback(String key) {
				...
				intent.setClass(ChoseRecordActivity.this, SVisualizeRecordActivity.class);
	...
	private void getRecordList(){
		...
		GetRecordListLogic logic = new GetRecordListLogic(new GetRecordListCallBack() {
			...
			public void onGetRecordList(ArrayList<Record> mRecordList) {
				...
				ChoseRecordActivity.this.mRecordList.addAll(mRecordList);
				mAdapter.addDatas(ChoseRecordActivity.this.mRecordList);
	...
	public  void getSurRecordItem(final int recordId){
		CustomDialog dialog = new CustomDialog(ChoseRecordActivity.this);
		View view = LayoutInflater.from(ChoseRecordActivity.this).inflate(R.layout.view_overview_record, null, false);
