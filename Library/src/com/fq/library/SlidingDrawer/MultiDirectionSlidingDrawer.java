...
package com.fq.library.SlidingDrawer;
...
public class MultiDirectionSlidingDrawer extends ViewGroup {
	...
	protected void onMeasure( int widthMeasureSpec, int heightMeasureSpec )
	{
		...
		if ( mVertical ) {
			...
			mContent.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(height, heightSpecMode));  

			if(isOpened()){  
				heightSpecSize = handle.getMeasuredHeight() + mTopOffset + mContent.getMeasuredHeight();
			}else {  
                heightSpecSize = heightSpecSize - mTopOffset;  
            }  

			widthSpecSize = mContent.getMeasuredWidth();  
			...
			if(isOpened()){  
                widthSpecSize = handle.getMeasuredWidth() + mTopOffset + mContent.getMeasuredWidth();  
            } else {  
                widthSpecSize = handle.getMeasuredWidth() + mTopOffset ;  
            }  
            //widthSpecSize = handle.getMeasuredWidth() + mTopOffset + content.getMeasuredWidth();   
            heightSpecSize = mContent.getMeasuredHeight();  
